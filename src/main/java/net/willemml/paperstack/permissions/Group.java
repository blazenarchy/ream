package net.willemml.paperstack.permissions;
...
import static net.willemml.paperstack.permissions.PermissionsUtility.groupFolder;
...
public class Group {
    ...
    public Group attachToPlayer(Player player) {
        ...
        if (permissionAttachment == null) {
            permissionAttachment = player.addAttachment(PaperStack.PLUGIN);
    ...
    public Group load() {
        ...
        try {
            return PaperStack.gson.fromJson(new FileReader(groupFile), new TypeToken<Group>() {
            }.getType());
