package net.willemml.paperstack.player;
...
import net.willemml.paperstack.permissions.Track;
...
import static net.willemml.paperstack.player.PlayerDataUtilities.playerDataFolder;

public class PlayerData {
    @SerializedName("u")
    private UUID uuid;
    @SerializedName("ts")
    private long tokens = PaperStack.startingMoney;
    @SerializedName("tt")
    ...
    public Player getPlayer() {
        return PaperStack.PLUGIN.getServer().getPlayer(uuid);
    }
    ...
    public PlayerData save() {
        ...
        try {
            ...
            fw.write(PaperStack.gson.toJson(this));
            fw.flush();
            fw.close();
        } catch (Exception e) {
    ...
    public PlayerData load() {
        ...
        playerDataFile.getParentFile().mkdirs();
        try {
            return PaperStack.gson.fromJson(new FileReader(playerDataFile), new TypeToken<PlayerData>() {
            }.getType());
