...
import net.blazenarchy.ream.permissions.Track;
...
public class PlayerData {
    ...
    private UUID uuid;
    @SerializedName("ts")
    private long tokens = Ream.startingMoney;
    @SerializedName("tt")
    ...
    public Player getPlayer() {
        return Ream.PLUGIN.getServer().getPlayer(uuid);
    }
    ...
    public PlayerData save() {
        ...
        File playerDataFile = new File(PlayerDataUtilities.playerDataFolder + uuid.toString() + ".json");
    ...
    public PlayerData load() {
        File playerDataFile = new File(PlayerDataUtilities.playerDataFolder + uuid + ".json");
        playerDataFile.getParentFile().mkdirs();
        try {
            return Ream.gson.fromJson(new FileReader(playerDataFile), new TypeToken<PlayerData>() {
            }.getType());
